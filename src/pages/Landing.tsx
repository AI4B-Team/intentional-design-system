      ...
      <section className="py-16 md:py-24 border-b border-border">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
            {[
              { icon: Bot, name: "AI Voice Agent", premium: true },
              { icon: Car, name: "AI Driving For Dollars", premium: true },
              { icon: Brain, name: "Deal Intelligence", premium: true },
              { icon: Headphones, name: "AI Co-Pilot", premium: true },
              { icon: Target, name: "AI Lead Score", premium: true },
              ...
              { icon: Globe, name: "Instant Websites" },
