...
import { EVENT_COLORS, URGENCY_COLORS, EVENT_ICONS, getUrgency, getEventNavigation, handleQuickAction, type ViewMode, type CalendarViewTab } from "@/components/calendar/calendar-constants";
...
import { EventActions, AIContext } from "@/components/calendar/EventActions";
      ...
      <div className="flex flex-col h-full overflow-hidden bg-muted/30">
        ...
        <div className="flex flex-1 overflow-hidden">
          <div className="flex-1 flex flex-col overflow-auto p-5 bg-card">
            ...
            {viewTab === "feed" && (
              <CalendarFeedView events={filteredEvents} navigate={navigate} />
            )}
          </div>
