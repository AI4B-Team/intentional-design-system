...
import { X, AlertTriangle, DollarSign, MapPin, Eye, ChevronDown, ChevronUp, Flame, Scale, Download, User, Phone, Mail, SlidersHorizontal } from "lucide-react";
...
export function D4DScanPanel({ properties, onClose, onFocusProperty, totalScanned }: D4DScanPanelProps) {
  ...
  return (
    <div className="h-full flex flex-col bg-background border-l w-[400px] min-w-[400px] relative">
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-1 mt-1">
                      ...
                      {property.phoneAvailable && <Phone className="h-2.5 w-2.5 text-green-600" />}
                      {property.emailAvailable && <Mail className="h-2.5 w-2.5 text-blue-600" />}
                    </div>
                  </div>
                ...
                {isExpanded && (
                  <div className="px-2 pb-2 border-t bg-muted/20">
                    ...
                    <div className="flex gap-1.5 mt-2">
                      ...
                      <Button size="sm" variant="outline" className="h-7 text-xs flex-1 gap-1" onClick={(e) => { e.stopPropagation(); onFocusProperty(property); }}>
