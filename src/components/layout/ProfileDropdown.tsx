        ...
        >
          ...
          <div className="border-t border-border py-2 px-4 space-y-1">
            <button
              ...
              className={cn(
                "w-full flex items-center justify-between py-2.5 px-2 rounded-md transition-colors",
                showLanguages ? "bg-muted" : "hover:bg-muted"
              )}
            >
              <div className="flex items-center gap-3">
            ...
            <button
              ...
              className={cn(
                "w-full flex items-center justify-between py-2.5 px-2 rounded-md transition-colors",
                showThemes ? "bg-muted" : "hover:bg-muted"
              )}
            >
              <div className="flex items-center gap-3">
