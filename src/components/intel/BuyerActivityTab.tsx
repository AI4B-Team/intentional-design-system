      ...
      {view === "flips" && (
        <div className="space-y-3.5">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-3.5">
            ...
            <div className="bg-card border border-border rounded-xl p-4">
              <h3 className="text-sm font-bold text-foreground mb-0.5">Estimated Flip Margins</h3>
          ...
          {/* Flip Intel Table */}
          <div className="bg-card border border-border rounded-xl p-4">
            <h3 className="text-sm font-bold text-foreground mb-3">Flip Intelligence Summary</h3>
            <div className="overflow-x-auto">
